      ...
      <VContainer>
        <div class="d-flex justify-space-between flex-wrap gap-y-4">
          ...
          <div class="d-flex gap-x-1">
            <template
              v-for="(item, index) in [
                { title: 'github', icon: 'bxl-github', href: 'https://github.com/FleetSecure' },
                ...
                { title: 'instagram', icon: 'bxl-linkedin', href: 'https://www.linkedin.com/company/FleetSecure' },
              ]"
              :key="index"
            >
              <IconBtn
