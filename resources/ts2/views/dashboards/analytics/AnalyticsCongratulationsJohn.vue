  ...
  <VCard class="overflow-visible">
    <VRow no-gutters>
      <VCol
        ...
        order-sm="1"
      >
        <VCardItem class="pb-4 mt-4">
          <VCardTitle>
            <h4 class="text-h4 text-wrap">
              Congratulationss <strong>Johsn!</strong> <span class="text-high-emphasis">🎉</span>
            </h4>
          </VCardTitle>
        </VCardItem>
        ...
        <VCardText>
          <p>
            ...
            <br>
            Check your new sdasraising badge in your profile.
          </p>
      ...
      >
        <img
          ...
          :height="$vuetify.display.xs ? '165' : '186'"
